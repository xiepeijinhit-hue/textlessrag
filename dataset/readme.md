...
The spoken audio files for the Q&A were generated using Doubao’s TTS API [https://www.volcengine.com/docs/6561/1257544]. To ensure data generalization, we used as many different voice timbres as possible. The list of timbres involved is as follows:
